...
- **npm en vez de pnpm**: la instalación global de pnpm (y `corepack enable`) falló por permisos de Windows sobre `Program Files`. Se optó por npm workspaces para no perder tiempo en un problema de entorno ajeno al objetivo de la prueba.
